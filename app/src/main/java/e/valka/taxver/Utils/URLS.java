package e.valka.taxver.Utils;

public class URLS {
    public static final String Conductores = "https://taxver.azurewebsites.net/JSON/Conductores";
    public static final String LoginApp = "https://taxver.azurewebsites.net/JSON/LoginApp/";
    public static final String Conductor = "https://taxver.azurewebsites.net/JSON/Conductor/";
